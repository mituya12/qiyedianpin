...
export const ignoreTokens: string[] = [
	"/api/c/user/login", // 微信登录
	"/api/c/company/search", // 搜索企业
	"/api/c/company/detail/*", // 企业详情
	"/api/c/company/trending", // 热门企业
	"/api/c/company/similar/*", // 相似企业
	"/api/c/review/list", // 评价列表
	"/api/c/review/detail/*" // 评价详情
];
